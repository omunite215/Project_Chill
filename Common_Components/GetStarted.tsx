...
const GetStarted = () => {
  return (
    <section className=" flex flex-1 justify-between items-center xl:max-w-[85.375rem] w-full sm:px-16 px-6 py-6  sm:pt-[112px] pt-[56px] text-center">
      <section className="sm:p-6 p-3 sm:px-28 px-14 py-10 flex sm:flex-row flex-col justify-between items-center lg:gap-x-[527px] md:gap-x-[327px] gap-x-[227px] bg-PrimaryBlue rounded-3xl">
