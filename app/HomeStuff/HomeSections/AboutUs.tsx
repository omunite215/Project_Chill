  ...
  return (
    <section className="flex flex-col ms:items-start items-center justify-center">
      <section className="mt-10 bg-[#FFD035] w-full">
        <section className="flex justify-center md:items-start items-center sm:rotate-[3.3deg] rotate-0">
          <section className="flex md:flex-row flex-col items-start justify-between sm:px-48 sm:py-20 p-16 sm:gap-y-0 gap-y-10">
            <h1 className="sm:text-5xl text-3xl font-RocGrotesk font-semibold max-w-[384px] md:w-3/5 w-full sm:text-left text-center">
            ...
            <ul className="flex max-w-[592px] md:w-1/2 w-full flex-col gap-4 font-medium text-base sm:text-left text-center">
              ...
              <li>
                ...
                continuity of working on our client&rsquo;s long-standing
                platforms that ensure our processes never drop.
              </li>
            </ul>
          </section>
          <section className="sm:flex hidden rotate-[15deg] items-start justify-start gap-[100px] absolute -bottom-8 left-12 sm:mt-0 mt-40">
